...
const watcherIdList = [
  ...
  15072004, 15072003, 15072001, 15072002, 15072006, 15072007, 15072008, 15072009, 15072010, 15072011,
]

const meetCondList = [5072001, 5072002, 5072003, 5072004, 5072005, 5072006, 5072007, 5072008, 5072009, 5072011, 5072013]
