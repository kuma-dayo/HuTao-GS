...
export default class SceneGroup {
  ...
  private async loadGadgets(gadgets: SceneGadgetScriptConfig[], force = false) {
    ...
    for (const gadget of gadgets) {
      ...
      /*
      It is originally called by the EventGadgetCreate trigger, but if this trigger is implemented, out of memory will be generated by wasmoon.
      This problem needs to be fixed.

      GadgetId: 70360010 - dungeon key
       */

      if (entity.gadgetId == 70360010) await entity.setWorktopOption([7])
